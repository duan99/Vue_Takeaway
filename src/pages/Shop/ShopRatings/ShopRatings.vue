  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on:onlyShowText}" @click="togleOnlyShowText">
          <span class="iconfont icongouxuan"></span>
        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType === 0 ? 'iconzan' : 'iconchaping'"></span>
                <span class="item" v-for="(item, index) in rating.recommend" :key="index">{{item}}</span>
              </div>
              <!--{{rating.rateTime | data-format}}:4、时间戳转日期-->
...
// 1、引入mapGetters后，再调用getters.js中的positiveSize方法
...
export default {
  ...
  mounted () {
    this.$store.dispatch('getShopRatings', () => {
      // 数据更新后并实现渲染时执行
      this.$nextTick(() => { // 检测数据更新的方法
        // new BScroll('.ratings', {// 注册滚动组件
        //   click:true//默认注册点击事件
        // })
        // 上下执行结果一样
        /* eslint-disable no-new */
        new BScroll(this.$refs.ratings, {// 注册滚动组件
          click: true// 默认注册点击事件
        })
      })
    })
  ...
  computed: {
    ...
    // 2、调用getters.js中的positiveSize方法
