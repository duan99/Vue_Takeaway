  ...
  <div class="shop-header">
    ...
    <nav class="shop-nav" :style="{backgroundImage:`url(${info.bgImg})`}">
      <a class="back" @click="$router.back()">
        <i class="iconfont iconzuojiantou2"></i>
      </a>
    </nav>
...
<span class="mini-tag">品牌</span>
          ...
          <i class="iconfont iconyousanjiaoxing"></i>
        </h2>
    ...
    <div class="activity-sheet" v-show="supportsShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" :class="index<=2?supportClasses[index]:supportClasses[2]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
